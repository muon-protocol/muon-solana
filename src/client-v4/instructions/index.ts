...
export const addGroup = function (pubkey_x: BN, pubkey_y_parity: number, app_id: BN) {
    const serialized = borsh.serialize(AddGroupSchema, new AddGroup({pubkey_x, pubkey_y_parity, app_id}));
